...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-center">
            ...
            <li class="nav-item">
            <a class="nav-link" href="manage_book.php">Manage Books</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="add_cat.php">Add New Category</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="add_author.php">Add New Author</a>
            </li>

            <li class="nav-item">
            <a class="nav-link" href="manage_author.php">Manage Author</a>
            </li>
        </ul>
    </div>
</nav><br>
...
<div class="row">
    ...
    <div class="col-md-3" style="margin: 0px">
        <div class="card bg-light" style="width: 300px">
            ...
            <div class="card-body">
                <p class="card-text">No of available books: <?php echo get_available_book_count(); ?></p>
                <a class="btn btn-primary" href="view_available_book.php" target="_blank">View Available Books</a>
            </div>
        </div>
    </div>
    <div class="col-md-3" style="margin: 0px">
        <div class="card bg-light" style="width: 300px">
            ...
            <div class="card-body">
                <a class="btn btn-warning" href="view_fines.php" target="_blank">View Fines</a>
            </div>
        </div>
    </div>
	<div class="col-md-3" style="margin: 0px">
    <div class="card bg-light" style="width: 300px">
        ...
        <div class="card-body">
            <a class="btn btn-warning" href="view_queries.php" target="_blank">View Queries</a>
        </div>
    </div>
</div>
